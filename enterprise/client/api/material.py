...
class WeChatMaterial(BaseWeChatAPI):
    ...
    async def add_articles(self, articles):
        """
        新增永久图文素材
        详情请参考
    ...
    async def add(self, agent_id, media_type, media_file):
        """
        新增其它类型永久素材
        详情请参考
        https://qydev.weixin.qq.com/wiki/index.php?title=%E4%B8%8A%E4%BC%A0%E6%B0%B8%E4%B9%85%E7%B4%A0%E6%9D%90
    ...
    async def get_url(self, agent_id, media_id):
        """
        获取永久素材下载地址
        详情请参考
    ...
    async def get(self, agent_id, media_id):
        """
        获取永久素材
        详情请参考
        https://qydev.weixin.qq.com/wiki/index.php?title=%E8%8E%B7%E5%8F%96%E6%B0%B8%E4%B9%85%E7%B4%A0%E6%9D%90
        ...
        """
        return await self._get(self.get_url(agent_id, media_id))

    async def get_articles(self, agent_id, media_id):
        """
        获取永久素材：图文消息素材
        详情请参考
        https://qydev.weixin.qq.com/wiki/index.php?title=%E8%8E%B7%E5%8F%96%E6%B0%B8%E4%B9%85%E7%B4%A0%E6%9D%90
    ...
    async def delete(self, agent_id, media_id):
        """
        删除永久素材
        详情请参考
    ...
    async def update_articles(self, agent_id, media_id, articles):
        """
        修改永久图文素材
        详情请参考
    ...
    async def get_count(self, agent_id):
        """
        获取素材总数
        详情请参考
    ...
    async def batchget(self, agent_id, media_type, offset=0, count=20):
        """
        批量获取永久素材列表
        详情请参考
