...
class WeChatExternalContact(BaseWeChatAPI):
    ...
    async def get(self, external_userid):
        ...
        :return: 返回的 JSON 数据包
        """
        return await self._get('externalcontact/get',
                         params={'external_userid': external_userid})

    async def add_contact_way(self, type, scene, style=None,
    ...
    async def update_contact_way(self, config_id, remark, skip_verify=True,
    ...
    async def add_msg_template(self, template):
        """
        添加企业群发消息模板
    ...
    async def get_user_behavior_data(self, userid,
                               start_time, end_time):
        """
        获取员工行为数据
    ...
    async def send_welcome_msg(self, template):
        """
        发送新客户欢迎语
    ...
    async def get_unassigned_list(self, page_id, page_size):
        """
        获取离职成员的客户列表
    ...
    async def transfer(self, external_userid, handover_userid,
                 takeover_userid):
        """
        离职成员的外部联系人再分配
    ...
    async def get_corp_tag_list(self, tag_ids=None):
        """
        企业可通过此接口获取企业客户标签详情
    ...
    async def add_corp_tag(self, group_id, group_name, order, tags):
        """
    ...
    async def edit_corp_tag(self, id, name, order):
        """
    ...
    async def del_corp_tag(self, tag_id=None, group_id=None):
        """
    ...
    async def mark_tag(self, userid, external_userid, add_tag=None, remove_tag=None):
        """
