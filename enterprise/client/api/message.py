...
class WeChatMessage(BaseWeChatAPI):
    ...
    * 小程序通知消息
    ...
    async def send(self, agent_id, user_ids, party_ids='',
             tag_ids='', msg=None):
        """
    ...
    async def send_text(self, agent_id, user_ids, content,
    ...
    async def send_text_card(self, agent_id, user_ids, title, description, url, btntxt='详情',
                       party_ids='', tag_ids=''):
        """ 文本卡片消息
    ...
    async def send_image(self, agent_id, user_ids, media_id,
                   party_ids='', tag_ids='', safe=0):
        return await self.send(
            agent_id,
            user_ids,
    ...
    async def send_voice(self, agent_id, user_ids, media_id,
                   party_ids='', tag_ids='', safe=0):
        return await self.send(
            agent_id,
            user_ids,
    ...
    async def send_video(self, agent_id, user_ids, media_id, title=None,
    ...
    async def send_file(self, agent_id, user_ids, media_id,
                  party_ids='', tag_ids='', safe=0):
        return await self.send(
            agent_id,
            user_ids,
    ...
    async def send_articles(self, agent_id, user_ids, articles,
                      party_ids='', tag_ids=''):
        articles_data = []
    ...
    async def send_mp_articles(self, agent_id, user_ids, articles,
                         party_ids='', tag_ids='', safe=0):
        articles_data = []
        for article in articles:
            articles_data.append({
    ...
    async def send_markdown(self, agent_id, user_ids, content, party_ids='', tag_ids=''):
        """markdown消息
