...
class WeChatMaterial(BaseWeChatAPI):
    ...
    async def update_article(self, media_id, index, article):
        """
        修改永久图文素材
        详情请参考
    ...
    async def update_articles(self, media_id, index, articles):
        """
        修改永久图文素材
        详情请参考
        https://developers.weixin.qq.com/doc/offiaccount/Asset_Management/Editing_Permanent_Rich_Media_Assets.html
        ...
        :return: 返回的 JSON 数据包
        """
        return await self.update_article(media_id, index, articles[index])
