...
class WeChatWxa(BaseWeChatAPI):
    ...
    async def get_wxa_code_unlimited(self,
                               scene,
                               width=430,
                               auto_color=False,
                               line_color={"r": "0", "g": "0", "b": "0"},
    ...
    async def send_template_message(self, user_id, template_id, data, form_id, page=None, color=None, emphasis_keyword=None):
        """
        发送模板消息
        详情请参考
    ...
    async def modify_domain(self, action, request_domain=(), wsrequest_domain=(), upload_domain=(), download_domain=()):
        """
        修改小程序服务器授权域名
        详情请参考
    ...
    async def check_text_security(self, content):
        """
        检查一段文本是否含有违法违规内容。
        详情请参考
