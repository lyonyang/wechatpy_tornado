...
class WeChatShakeAround(BaseWeChatAPI):
    ...
    async def update_device(self, device_id=None, uuid=None, major=None,
    ...
    async def bind_device_location(self, poi_id, device_id=None, uuid=None,
    ...
    async def search_device(self, identifiers=None, apply_id=None,
                      begin=0, count=10):
        """
        查询设备列表
        详情请参考
    ...
    async def update_page(self, page_id, title, description,
    ...
    async def bind_device_pages(self, page_ids, bind, append, device_id=None,
    ...
    async def get_device_statistics(self, begin_date, end_date, device_id=None,
                              uuid=None, major=None, minor=None):
        """
        以设备为维度的数据统计接口
