...
class WeChatCard(BaseWeChatAPI):
    ...
    async def update_movie_ticket(self, code, ticket_class, show_time, duration,
    ...
    async def checkin_boardingpass(self, code, passenger_name, seat_class,
    ...
    async def get_redirect_url(self, url, encrypt_code, card_id):
        ...
        获取卡券跳转外链
        """
        from wechatpy_tornado.utils import WeChatSigner
    ...
    async def set_activate_user_form(self, card_id, **kwargs):
        ...
        common_field_id_list 值见常量 `wechatpy_tornado.constants.UserFormInfoFlag`
