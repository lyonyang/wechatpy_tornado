...
class WeChatMessage(BaseWeChatAPI):
    ...
    async def send_video(self, user_id, media_id, title=None,
    ...
    async def send_music(self, user_id, url, hq_url, thumb_media_id,
    ...
    async def _send_mass_message(self, group_or_users, msg_type, msg,
    ...
    async def send_mass_text(self, group_or_users, content,
                       is_to_all=False, preview=False,
                       send_ignore_reprint=0, client_msg_id=None):
        """
        群发文本消息
    ...
    async def send_mass_image(self, group_or_users, media_id,
                        is_to_all=False, preview=False,
                        send_ignore_reprint=0, client_msg_id=None):
        """
        群发图片消息
    ...
    async def send_mass_voice(self, group_or_users, media_id,
                        is_to_all=False, preview=False,
                        send_ignore_reprint=0, client_msg_id=None):
        """
        群发语音消息
    ...
    async def send_mass_video(self, group_or_users, media_id, title=None,
    ...
    async def send_mass_article(self, group_or_users, media_id,
                          is_to_all=False, preview=False,
                          send_ignore_reprint=0, client_msg_id=None):
        """
        群发图文消息
    ...
    async def send_mass_card(self, group_or_users, card_id,
                       is_to_all=False, preview=False,
                       send_ignore_reprint=0, client_msg_id=None):
        """
        群发卡券消息
