...
from wechatpy_tornado.fields import (
    StringField,
    IntegerField,
    ImageField,
    VoiceField,
...
from wechatpy_tornado.messages import BaseMessage, MessageMetaClass
from wechatpy_tornado.utils import to_text, to_binary
...
def deserialize_reply(xml, update_time=False):
    ...
    :rtype: wechatpy_tornado.replies.BaseReply
    """
    if not xml:
        return EmptyReply()
