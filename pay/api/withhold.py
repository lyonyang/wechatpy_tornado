...
from wechatpy_tornado.utils import timezone
from wechatpy_tornado.pay.utils import get_external_ip, calculate_signature
...
class WeChatWithhold(BaseWeChatPayAPI):
    ...
    async def query_signing(self, contract_id=None, plan_id=None, contract_code=None, openid=None, version="1.0"):
        """
        查询签约关系 api
    ...
    async def apply_deduct(self, body, total_fee, contract_id, notify_url, out_trade_no=None,
    ...
    async def apply_cancel_signing(self, contract_id=None, plan_id=None, contract_code=None,
